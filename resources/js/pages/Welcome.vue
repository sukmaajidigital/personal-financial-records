    ...
    >
        ...
        >
            ...
            <div class="mb-12">
                ...
                >
                    ...
                    <div
                        class="grid gap-px bg-gray-200 sm:grid-cols-2 dark:bg-[#2E2E2A]"
                    >
                        <div
                        ...
                        >
                            <div class="flex items-start justify-between">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        >
                                            <span
                                                class="flex items-center gap-1 text-xs text-gray-500 dark:text-[#A1A09A]"
                                            >
                                                <span
                                            ...
                                            <span
                                                class="text-xs text-gray-400 dark:text-[#A1A09A]"
                                                >{{ plan.planned_date }}</span
                                            >
                                        </div>
                                        <p
                                            v-if="plan.notes"
                                            class="mt-0.5 text-xs text-gray-400 dark:text-[#A1A09A]/70"
                                        >
                                            {{ plan.notes }}
                                        </p>
                                    </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="mt-1">
                                        <span
                                            class="inline-flex items-center rounded-full bg-amber-50 px-2 py-0.5 text-xs font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"
                                        >
                                            Draft
                                        </span>
                                    </div>
                            ...
                            >
                                <button
                                    class="inline-flex items-center gap-1 rounded-md border border-gray-200 px-2.5 py-1 text-xs font-medium text-gray-600 transition hover:bg-gray-100 dark:border-[#3E3E3A] dark:text-[#A1A09A] dark:hover:bg-[#2E2E2A]"
                                >
                                    Edit
                                </button>
                                <button
                                    class="inline-flex items-center gap-1 rounded-md bg-emerald-600 px-2.5 py-1 text-xs font-medium text-white transition hover:bg-emerald-700"
                                >
                                    <Send class="h-3 w-3" />
                                    Post
                                </button>
            ...
            <div class="mb-12">
                ...
                >
                    ...
                    >
                        <div class="bg-white p-4 sm:p-6 dark:bg-[#161615]">
                            <span
                                class="text-xs font-medium text-gray-500 dark:text-[#A1A09A]"
                                >Total Pemasukan</span
                            >
                            <p
                                class="mt-2 text-lg font-bold text-emerald-600 sm:text-2xl"
                            >
                                Rp 108.2M
                            </p>
                        ...
                        <div class="bg-white p-4 sm:p-6 dark:bg-[#161615]">
                            ...
                            >
                            <p
                                class="mt-2 text-lg font-bold text-red-500 sm:text-2xl"
                            >
                                Rp 45.8M
                            </p>
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        >
                            ...
                            <span class="ml-auto text-[10px]"
                                >Filter: Tanggal, Bulan, Tahun, Kategori</span
                            >
                        </div>
                    </div>
                </div>
        ...
        <div class="fixed right-6 bottom-6 z-50">
            <div
                ...
                class="absolute right-0 bottom-full mb-2 w-48 rounded-lg bg-gray-900 p-2 text-center text-xs text-white shadow-lg dark:bg-[#2E2E2A]"
            >
                Punya saran? Bantu kami lebih baik!
                <div
                    class="absolute right-5 -bottom-1 h-2 w-2 rotate-45 bg-gray-900 dark:bg-[#2E2E2A]"
                />
            </div>
            <Link
                v-if="$page.props.auth.user"
