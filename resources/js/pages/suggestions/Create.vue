...
const focusOptions = [
    {
        value: 'fitur_baru',
        label: 'Fitur Baru',
        desc: 'Saran penambahan fitur baru',
    },
    {
        value: 'pengurangan_fitur',
        label: 'Pengurangan Fitur',
        desc: 'Saran menghapus atau menyederhanakan fitur',
    },
    {
        value: 'tampilan',
        label: 'Perubahan Tampilan',
        desc: 'Saran perubahan UI/UX',
    },
    {
        value: 'performa',
        label: 'Performa',
        desc: 'Saran peningkatan kecepatan/efisiensi',
    },
    {
        value: 'keamanan',
        label: 'Keamanan',
        desc: 'Saran terkait keamanan data',
    },
                    ...
                    <CardContent class="space-y-4 pt-6">
                        ...
                        <div class="grid gap-2">
                            ...
                            <p class="text-xs text-muted-foreground">
                                Upload screenshot atau mockup. Maks 2MB.
                            </p>
                            <div class="flex items-center gap-4">
                                <label
                                    for="image"
