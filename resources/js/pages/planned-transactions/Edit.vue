...
import type { BreadcrumbItem, Category, PlannedTransaction } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit Rencana', href: '#' },
];

const form = useForm({
    category_id: String(props.plannedTransaction.category_id),
...
function submit() {
    form.put(`/planned-transactions/${props.plannedTransaction.id}`);
}
...
<template>
    <Head title="Edit Rencana Transaksi" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-6 p-4 md:p-6">
            <div class="flex items-center gap-4">
                <Button variant="ghost" size="icon" as-child>
                    <Link href="/planned-transactions">
                        <ArrowLeft class="size-4" />
                    </Link>
                </Button>
                <Heading
                    title="Edit Rencana Transaksi"
                    description="Ubah detail rencana transaksi."
                />
            </div>
