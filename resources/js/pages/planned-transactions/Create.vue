...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Rencana', href: '/planned-transactions/create' },
];
...
function submit() {
    form.post('/planned-transactions');
}
...
<template>
    <Head title="Tambah Rencana Transaksi" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-6 p-4 md:p-6">
            <div class="flex items-center gap-4">
                ...
                <Heading
                    title="Tambah Rencana Transaksi"
                    description="Buat rencana transaksi baru."
                />
            </div>
            ...
            <Card class="mx-auto w-full max-w-2xl">
                <form @submit.prevent="submit">
                    ...
                    <CardFooter class="flex justify-end gap-2">
                        ...
                        <Button type="submit" :disabled="form.processing">Simpan Rencana</Button>
                    </CardFooter>
                </form>
            </Card>
        </div>
