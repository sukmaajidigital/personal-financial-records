        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                ...
                >
                    ...
                    <div v-if="isGoogleUser" class="-mt-2">
                        <p class="text-sm text-muted-foreground">
                            <span
                                class="inline-flex items-center gap-1.5 rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-blue-600/20 ring-inset dark:bg-blue-500/10 dark:text-blue-400 dark:ring-blue-500/20"
                            >
                                <svg
                                    class="h-3.5 w-3.5"
                                    viewBox="0 0 24 24"
                    ...
                    >
                        <p class="-mt-4 text-sm text-muted-foreground">
                            ...
                            >
                                Click here to resend the verification code.
                            </Link>
                        </p>
